...
class LeggedRobot(BaseTask):
    ...
    def reset_idx(self, env_ids):
        ...
        self.gait_indices[env_ids] = random.uniform(0,1)
    ...
    def _update_terrain_curriculum(self, env_ids):
        ...
        self.terrain_levels[env_ids] = torch.where(
            self.terrain_levels[env_ids] >= self.cfg.terrain.center_span * 2,
    ...
    def compute_observations(self):
        ...
        """
        #obs:6+12*3+13=55
        #privildeged obs for critic:187+24
        ...
        command = torch.cat((torch.sin(self.foot_indices[:, 0].unsqueeze(1)),torch.cos(self.foot_indices[:, 0].unsqueeze(1)),self.commands[:,3:9],self.commands[:,0:3]), dim=-1)
