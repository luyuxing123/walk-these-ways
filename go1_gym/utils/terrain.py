...
class Terrain:
    ...
    def _load_cfg(self, cfg):
        ...
        cfg.proportions = cfg.terrain_proportions
    ...
    def make_terrain(self, cfg, choice, difficulty, proportions,i,j):
        ...
        stair_height = -0.15* difficulty
        # stair_height = 0
        stair_width = random.randint(30, 40) / 100
        ...
        discrete_obstacles_height = 0.02 + difficulty * 0.08

        if choice < proportions[0]:
            pass
        elif choice < proportions[1]:
            terrain_utils.pyramid_stairs_terrain(terrain, step_width=stair_width, step_height=stair_height,
                                                 platform_size=2.)
